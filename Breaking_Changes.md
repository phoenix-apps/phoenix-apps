...
This document defines what we class as "Breaking Changes", and which are acceptable, and which are not. If breaking changes are introduced, the changes are significantly less likely to be approved.  
Breaking changes may still be approved, but we recommend you avoid them wherever possible.

&#10003; **Allowed** and &#10007; **Disallowed** only applies to publicly shared Nuget libraries, such as the `Phnx` projects.
